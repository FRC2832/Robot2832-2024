...
public class SwerveSubsystem extends SubsystemBase {
    final PIDConstants TRANSLATION_PID = new PIDConstants(0.7, 0, 0);
    final PIDConstants ANGLE_PID = new PIDConstants(0.4, 0, 0.01);
    ...
    public void setupPathPlanner() {
        AutoBuilder.configureHolonomic(
                ...
                () -> {
                    ...
                    return UtilFunctions.getAlliance() == DriverStation.Alliance.Red;
                },
    ...
    public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY,
        ...
        return run(() -> {
            // Make the robot move
            swerveDrive.drive(new Translation2d(Math.pow(translationX.getAsDouble(), 3),
    ...
    public void drive(Translation2d translation, double rotation, boolean fieldRelative) {
        ...
        swerveDrive.drive(translation.times(inv),
                rotation,
                fieldRelative,
    ...
    /**
     * Set the current pose (position and rotation) of the robot.
     *
     * @param pose Pose to put the robot at
     */
    ...
    public Command aimAtTargetBackwards(Supplier<Pose2d> target) {
        try (var pid = new PIDController(.35/Math.PI, .45, 0)) {
            ...
            return run(() -> { 
                ...
                double curAngle = robotPose.getRotation().getRadians();
            ...
            .finallyDo(()->{ drive(new ChassisSpeeds(0, 0, 0)); aimedAtTarget.set(false);});
        }
    }
    ...
    public void setWheelStates(SwerveModuleState[] wheelStates) {
        ...
        for (int i=0; i<modules.length; i++) {
            modules[i].setDesiredState(wheelStates[i], false, true);
        }
    }

    public void addVisionMeasurement(AddVisionParams params) {
        swerveDrive.addVisionMeasurement(params.pose, params.timestamp, params.stdDeviations);
    }
